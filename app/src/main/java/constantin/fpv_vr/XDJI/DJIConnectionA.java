...
public class DJIConnectionA extends AppCompatActivity {
    private static final String TAG="DJIConnectionA";
        ...
        if (isRegistrationInProgress.compareAndSet(false, true)) {
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    DJISDKManager.getInstance().registerApp(DJIConnectionA.this.getApplicationContext(), new DJISDKManager.SDKManagerCallback() {
                        @Override
