...
import constantin.test.SimpleTranscoder;
import constantin.test.TranscodeService;

public class MigrateFilesService extends Service {
    private static final String TAG=MigrateFilesService.class.getSimpleName();
