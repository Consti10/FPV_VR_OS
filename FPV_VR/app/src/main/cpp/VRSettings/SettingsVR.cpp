...
#define TAG "SettingsVR"
#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG, TAG, __VA_ARGS__)


SettingsVR::SettingsVR(JNIEnv *env, jobject androidContext,jfloatArray undistData) {
    ...
    VR_DistortionCorrection=settingsN.getBoolean(IDVR::VR_DistortionCorrection);
    ...
    LOGD("%f %f %d",VR_InterpupilaryDistance,VR_SceneScale,VR_DistortionCorrection);
}
