...
#endif
public:
    OSDRenderer(TelemetryReceiver* telemetryReceiver,const GLRenderColor* glRenderColor,const GLRenderText* glRenderText);
    void placeGLElementsMono(float videoX,float videoY,float videoZ,float videoW,float videoH);
    void placeGLElementsStereo(float videoX,float videoY,float videoZ,float videoW,float videoH);
    //
