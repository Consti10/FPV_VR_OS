        ...
        if (mavlink_parse_char(0, c, &msg, &status)) {
            ...
            switch (msg.msgid){
                ...
                case MAVLINK_MSG_ID_GLOBAL_POSITION_INT:
                    ...
                    td->gps_baro_altitude = mavlink_msg_global_position_int_get_relative_alt(&msg)/1000.0f;
                ...
                case MAVLINK_MSG_ID_ATTITUDE:
                    ...
                    td->roll = mavlink_msg_attitude_get_roll(&msg)*57.2958f;
                    td->pitch = mavlink_msg_attitude_get_pitch(&msg)*57.2958f;
                    td->validmsgsrx++;
